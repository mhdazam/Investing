...
public class Assignment {
 ...
 @BeforeMethod
  ...
  @Test(priority = 3)
  public void verifySigninSingout() throws Exception {
	  //gotoHomepage();
	  signin("mzazam07@gmail.com", "nyc2015");
	  verifyTitle();
	  signout();
  }
  
  @Test(priority = 2, enabled = false)		//skip test
  ...
  public void verifyTitle() {
	  ...
	  Reporter.log("Correct page displayed");
  }
